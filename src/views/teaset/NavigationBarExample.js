...
export default class NavigationBarExample extends NavigationPage {
  ...
  renderLeftRightView(item) {
    switch (item) {
      ...
      case 'Icon button':
        return (
          <NavigationBar.IconButton icon={require('../../assets/images/icons/search.png')} />
        )
      case 'Two icon button':
        return (
          <View style={{flexDirection: 'row'}}>
            <NavigationBar.IconButton icon={require('../../assets/images/icons/edit.png')} />
            <NavigationBar.IconButton icon={require('../../assets/images/icons/trash.png')} />
          </View>
        )
    }
  }
  ...
  renderNavigationBar() {
    const {customBackground, hidden, animated, statusBarHidden} = this.state
    return (
      <NavigationBar
        style={this.style}
        type={this.type}
        ...
        background={!customBackground ? null
          : <Image style={{flex: 1}} resizeMode='cover' source={require('../../assets/images/teaset2.jpg')} />
        }
        hidden={hidden}
        animated={animated}
  ...
  renderPage() {
    const {type, title, leftView, rightView, bgColor, tintColor, customBackground, hidden, animated, statusBarStyle, statusBarHidden} = this.state
    return (
